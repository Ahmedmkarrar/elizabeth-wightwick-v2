    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-cream">
        <div className="container-content">
          <h1 className="heading-display text-charcoal">About Elizabeth Wightwick</h1>
            ...
            {[
              {
                ...
                description: 'You will always deal directly with us. No call centres, no juniors &mdash; just dedicated, experienced professionals who know your property and your goals.',
              },
              {
              ...
              <div key={value.title} className="text-center">
                ...
                <p
                  className="text-small text-slate font-inter font-light leading-relaxed"
